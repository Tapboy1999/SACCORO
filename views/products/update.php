...
<div class="form-create" >
   <h2 style="padding-bottom: 30px">Edit</h2>
   <form action="" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
      <div class="form-group row">
         <label for="title" class="col-md-3 col-sm-3 col-sms-3">Tên sản phẩm</label>
         <div class="col-md-9 col-sm-9">
            <input type="text" name="title" class="form-control" placeholder="Tên sản phẩm" required="" value="<?php echo $products['title']; ?>">
         </div>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
         ...
         <div class="col-md-9 col-sm-9">
            <input type="file" name="avatar" class="form-control-file" placeholder="" required="" style="outline-style: none" value="<?php echo $products['avatar']; ?>">
         </div>
      </div>
      <div class="form-group row">
         <label for="title" class="col-md-3 col-sm-3 col-sms-12">Giá bán</label>
         <div class="col-md-9 col-sm-9">
            <input type="text" name="price" class="form-control money-price" placeholder="Giá sản phẩm" required="" style="width: 50%" value="<?php echo number_format($products['price']); ?>">
         </div>
      </div>
      <div class="form-group row">
         <label for="title" class="col-md-3 col-sm-3 col-sms-12">Giá sale</label>
         <div class="col-md-9 col-sm-9">
            <input type="text" name="sales" class="form-control money-sales" placeholder="Giá khuyến mại" style="width: 50%" value="<?php echo number_format($products['sales']); ?>">
         </div>
      </div>
      <div class="form-group row">
         <label for="title" class="col-md-3 col-sm-3 col-sms-12">Số lượng</label>
         <div class="col-md-9 col-sm-9">
            <input type="number" name="amount" class="form-control" placeholder="Số lượng" required="" style="width: 50%" value="<?php echo $products['amount']; ?>">
         </div>
      </div>
      <div class="form-group row">
         <label for="title" class="col-md-3 col-sm-3 col-sms-12">Description</label>
         <div class="col-md-9 col-sm-9">
            <textarea name="content" class="form-control" style="height: 300px"><?php echo $products['content']; ?></textarea> 
         </div>
      </div>
      <div class="form-group row">
